...
def update_or_crete_user_tokens(session_id, access_token, token_type, expires_in, refresh_token):
...
def refresh_spotify_token(session_id):
  ...
  update_or_crete_user_tokens(session_id, access_token, token_type, expires_in, refresh_token)
